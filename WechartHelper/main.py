...
if __name__ == '__main__':
	parser = argparse.ArgumentParser(description="Wechat helper(微信小助手), Author: Charles, WeChat Official Accounts: Charles_pikachu(微信公众号: Jeffrey的皮卡丘), Version: V0.1.0")
	...
	if args.option == 'analysisFriends':
		...
		analysisFriends().index(savedir=savedir)
		...
		autoReply().index(keywords=keywords, replycontents=contents)
	else:
